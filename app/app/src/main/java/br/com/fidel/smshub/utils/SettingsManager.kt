...
class SettingsManager {
    ...
    fun updateSettings(){
        ...
        this.sendURL =
            sharedPref!!.getString(context.getString(R.string.preference_send_url), defaultSendURL)!!
        ...
        this.deviceId =
            sharedPref!!.getString(context.getString(R.string.preference_device_id), defaultDeviceId)!!
    }
